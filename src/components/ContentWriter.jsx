...
const ContentWriter = () => {
    return (
        <>
            <div className=" bg-dark-gray flex justify-center items-center text-white py-12">
...
const ArticleCard = ({ title, link, description }) => {
    return (
        <div className="bg-dark-gray my-4 text-gray-400 p-6 rounded-lg border border-gray-600 hover:border-blue-500 transition duration-300 transform hover:scale-105">
